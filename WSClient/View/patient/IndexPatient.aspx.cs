...
namespace WSClient.View.Patient
{
    public partial class IndexPatient : System.Web.UI.Page
    {
        ...
        public void loadGrid()
        {
            ...
            GVPatients.DataSource = patientWSClient.GetAllPatients();
        ...
        protected void OnDeletePatient(object sender, GridViewDeleteEventArgs e)
        {
            ...
            VO_Diagnostic diagnostic = diagnosticWSClient.GetDiagnosticByPatientId(idPatient);
            ...
            else
            {
                ...
                response = patientWSClient.DeletePatient(idPatient);
            }
