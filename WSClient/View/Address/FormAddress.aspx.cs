    ...
    public partial class FormAddress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    VO_Address address = AddressWSClient.GetAddressById(_id);
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["Id"] == null)
                {
                    outputResult = AddressWSClient.CreateAddress(address);
                    ...
                    if (!outputResult.ToUpper().Contains("ERROR"))
                    {
                        ...
                        type = "warning";
                        SweetAlert.Sweet_Alert(title,response,type, this.Page, this.GetType(), "IndexAddress.aspx");
                ...
                else
                {
                    ...
                    outputResult = AddressWSClient.UpdateAddress(address);
                    //HttpContext.Current.Response.Redirect("IndexAddress.aspx");
                    SweetAlert.Sweet_Alert(title, response, type, this.Page, this.GetType(), "IndexAddress.aspx");
