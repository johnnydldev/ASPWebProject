<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IndexTreatment.aspx.cs" Inherits="WSClient.View.Treatment.IndexTreatment" %>
      ...
      <div class="row">
          ...
          <asp:GridView ID="GVTreatments" runat="server"
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="recommendTreatment" HeaderText="Nombre" ItemStyle-Width="85px" />
