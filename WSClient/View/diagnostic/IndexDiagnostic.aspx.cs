...
namespace WSClient.View.Diagnostic
{
    public partial class IndexDiagnostic : System.Web.UI.Page
    {
        ...
        public void loadGrid()
        {
            ...
            GVDiagnostics.DataSource = diagnosticWSClient.GetAllDiagnostics();
        ...
        protected void OnDeleteDiagnostic(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool response = diagnosticWSClient.DeleteDiagnostic(idDiagnostic);
            ...
            if (!response)
            {
                ...
                type = "error";
                SweetAlert.Sweet_Alert(title, msg, type, this.Page, this.GetType(), "IndexDiagnostic.aspx");
