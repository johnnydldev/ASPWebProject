    ...
    public partial class FormDiagnostic : System.Web.UI.Page
    {
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["Id"] == null)
                {
                    outputCreate = diagnosticWSClient.CreateDiagnostic(Diagnostic);
                ...
                else
                {
                    ...
                    outputUpdate = diagnosticWSClient.UpdateDiagnostic(Diagnostic);
                }
        ...
        private void chargeDropdownList()
        {
            ...
            List<ServiceDoctor.VO_Doctor> doctors = doctorWSClient.GetAllDoctorsWithNameCompete().ToList();
            List<ServiceLabResult.VO_Laboratory_Result> labResults = labResultWSClient.ListLabResults().ToList();
            List<ServicePatient.VO_Patient> patients = patientWSClient.GetAllPatientsWithNameComplete().ToList();
            List<ServiceTreatment.VO_Treatment>  treatments = treatmentWSClient.GetAllTreatments().ToList();
