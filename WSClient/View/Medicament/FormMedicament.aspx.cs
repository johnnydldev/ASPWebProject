...
namespace WSClient.View.Medicament
{
    public partial class FormMedicament : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    VO_Medicament Medicament = MedicamentWSClient.GetMedicamentById(_id);
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["Id"] == null)
                {
                    outputResult = MedicamentWSClient.CreateMedicament(Medicament);
                ...
                else
                {
                    ...
                    outputResult = MedicamentWSClient.UpdateMedicament(Medicament);
                    HttpContext.Current.Response.Redirect("IndexMedicament.aspx");
                }
