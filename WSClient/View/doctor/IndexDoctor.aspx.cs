...
namespace WSClient.View.Doctor
{
    public partial class IndexDoctor : System.Web.UI.Page
    {
        ...
        public void loadGrid()
        {
            ...
            GVDoctors.DataSource = doctorWSClient.GetAllDoctors();
        ...
        protected void OnDeleteDoctor(object sender, GridViewDeleteEventArgs e)
        {
            ...
            VO_Diagnostic diagnostic = diagnosticWSClient.GetDiagnosticByDoctorId(idDoctor);
            ...
            else
            {
                ...
                response = doctorWSClient.DeleteDoctor(idDoctor);
            }
