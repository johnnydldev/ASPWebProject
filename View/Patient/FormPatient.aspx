<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormPatient.aspx.cs" Inherits="AspWebProject.View.Patient.FormPatient" %>
       ...
       <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <%--Etiquetado--%>
                <asp:Label ID="lblNamePatient" runat="server" Text="Nombre:" CssClass="mt-3"></asp:Label>
                <%--Campo--%>
                <asp:TextBox ID="txtNamePatient" runat="server" CssClass="form-control"></asp:TextBox>
