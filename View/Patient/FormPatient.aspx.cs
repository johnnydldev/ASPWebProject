    ...
    public partial class FormPatient : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    VO_Patient Patient = BLLPatient.searchById(_id);
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["Id"] == null)
                {
                    outputCreate = BLLPatient.CreatePatient(Patient);
                ...
                else
                {
                    ...
                    outputUpdate = BLLPatient.UpdatePatient(Patient);
                    HttpContext.Current.Response.Redirect("IndexPatient.aspx");
                }
        ...
        private void chargeDropdownList()
        {
            ...
            foreach (VO_Address Patient in addresses)
            {
