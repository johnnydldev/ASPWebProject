    ...
    public partial class FormTreatment : System.Web.UI.Page
    {
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Request.QueryString["Id"] == null)
                {
                    outputCreate = BLLTreatment.CreateTreatment(Treatment);
                ...
                else
                {
                    ...
                    outputUpdate = BLLTreatment.UpdateTreatment(Treatment);
                    HttpContext.Current.Response.Redirect("IndexTreatment.aspx");
                }
        ...
        private void chargeDropdownList()
        {
            ...
            List<VO_Medicament> medicaments = BLLMedicament.ListMedicaments();
            ...
            foreach (VO_Medicament medicament in medicaments)
            {
